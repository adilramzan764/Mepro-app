...
class DiamondEarnedDialog extends StatefulWidget {
  final int diamondAmount;

  const DiamondEarnedDialog({
    Key? key,
    this.diamondAmount = 100,
  }) : super(key: key);

  @override
  State<DiamondEarnedDialog> createState() => _DiamondEarnedDialogState();
}

class _DiamondEarnedDialogState extends State<DiamondEarnedDialog> {
      ...
      child: Column(
        ...
        children: [
          ...
          Padding(
            ...
            child: Text(
              'You Earned ${widget.diamondAmount} Diamond with Today\'s Stamp',
              style:  TextStyle(
          ...
          SizedBox(height: ScreenSize.screenHeight(context) * 0.018),
           Text(
            'Tomorrow\'s Diamond holds even more points! Keep the streak alive!',
            style: TextStyle(
          ...
          CustomButton(text: 'OK', isPrimary: true, onPressed: (){
      ...
      children: [
        ...
        Container(
          ...
          child: Center(
            ...
            child: SvgPicture.asset(MyImageClass.pointsIcon,color: AppColors.whiteColor,
...
Future<void> showDiamondEarnedDialog(BuildContext context, {int diamondAmount = 100}) {
  return showDialog<void>(
    context: context,
    barrierDismissible: false,
    barrierColor: Colors.black.withOpacity(0.7),
    builder: (BuildContext context) {
      return DiamondEarnedDialog(diamondAmount: diamondAmount);
    },
  );
}
