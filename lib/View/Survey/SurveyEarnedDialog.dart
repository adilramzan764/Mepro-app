...
class SurveyEarnedDialog extends StatefulWidget {
  final int pointsAmount;

  const SurveyEarnedDialog({
    Key? key,
    this.pointsAmount = 100,
  }) : super(key: key);

  @override
  State<SurveyEarnedDialog> createState() => _DiamondEarnedDialogState();
}

class _DiamondEarnedDialogState extends State<SurveyEarnedDialog> {
      ...
      child: Column(
        ...
        children: [
          ...
          Padding(
            ...
            child: Text(
              'You Earned ${widget.pointsAmount} Points!',
              style: TextStyle(
          ...
          Text(
            'Keep the surveys coming! Every one unlocks points towards awesome rewards',
            style: TextStyle(
...
Future<void> showSurveyEarnedDialog(BuildContext context,
    {int diamondAmount = 100}) {
  return showDialog<void>(
    context: context,
    barrierDismissible: false,
    barrierColor: Colors.black.withOpacity(0.7),
    builder: (BuildContext context) {
      return SurveyEarnedDialog(pointsAmount: diamondAmount);
    },
  );
}
